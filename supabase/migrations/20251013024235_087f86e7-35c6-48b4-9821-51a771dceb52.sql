...
DROP POLICY IF EXISTS "Admins can view all survey insights" ON public.survey_insights;
DROP POLICY IF EXISTS "SK chairmen can view survey insights" ON public.survey_insights;
DROP POLICY IF EXISTS "Admins can insert survey insights" ON public.survey_insights;
DROP POLICY IF EXISTS "SK chairmen can insert survey insights" ON public.survey_insights;
DROP POLICY IF EXISTS "Admins can update survey insights" ON public.survey_insights;
DROP POLICY IF EXISTS "SK chairmen can update survey insights" ON public.survey_insights;
...
DROP INDEX IF EXISTS idx_survey_insights_type_month;
CREATE INDEX idx_survey_insights_type_month ON public.survey_insights(report_type, survey_month);

-- Drop trigger if exists and recreate
DROP TRIGGER IF EXISTS update_survey_insights_updated_at ON public.survey_insights;
